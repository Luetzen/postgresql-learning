...
Die vier Schalter, die den Weg bestimmen:
...
| `--jobs` | parallelisiert das Kopieren | mehr Last während des Laufs |
...
> Backup (Teil 20) — beides gehört zusammen.
...
| Platz | wie gewählt (`--copy`/`--link`) | eine leere Instanz |
